...
function canuck_custom_css() {
	...
	if ( 'default' !== $theme_fonts['header']['family'] ) {
		$ka_css .= 'h1, h2, h3, h4, h5, h6 {font-family:' . $theme_fonts['header']['family'] . ';}' . PHP_EOL;
	}
	...
	if ( in_array( 'Section 1', $home_area, true ) ) {
		...
		if ( '' !== $sec1_bg_image ) {
			if ( false === $sec1_use_parallax ) {
				$ka_css .= '.home-1-wide { background: url( ' . $sec1_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 2', $home_area, true ) ) {
		...
		$sec2_use_parallax = intval( get_theme_mod( 'canuck_section2_use_parallax', 0 ) );
		...
		if ( '' !== $sec2_bg_image ) {
			if ( 0 === $sec2_use_parallax ) {
				$ka_css .= '.home-2-wide { background: url( ' . $sec2_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 3', $home_area, true ) ) {
		...
		$sec3_use_parallax = intval( get_theme_mod( 'canuck_section3_use_parallax', 0 ) );
		...
		if ( '' !== $sec3_bg_image ) {
			if ( 0 === $sec3_use_parallax ) {
				$ka_css .= '.home-3-wide { background: url( ' . $sec3_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 4', $home_area, true ) ) {
		...
		$sec4_use_parallax = intval( get_theme_mod( 'canuck_section4_use_parallax', 0 ) );
		...
		if ( '' !== $sec4_bg_image ) {
			if ( 0 === $sec4_use_parallax ) {
				$ka_css .= '.home-4-wide { background: url( ' . $sec4_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 5', $home_area, true ) ) {
		...
		$sec5_use_parallax = intval( get_theme_mod( 'canuck_section5_use_parallax', 0 ) );
		...
		if ( '' !== $sec5_bg_image ) {
			if ( 0 === $sec5_use_parallax ) {
				$ka_css .= '.home-5-wide { background: url( ' . $sec5_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 6', $home_area, true ) ) {
		...
		$sec6_use_parallax = intval( get_theme_mod( 'canuck_section6_use_parallax', 0 ) );
		...
		if ( '' !== $sec6_bg_image ) {
			if ( 0 === $sec6_use_parallax ) {
				$ka_css .= '.home-6-wide { background: url( ' . $sec6_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 7', $home_area, true ) ) {
		...
		$sec7_use_parallax = intval( get_theme_mod( 'canuck_section7_use_parallax', 0 ) );
		...
		if ( '' !== $sec7_bg_image ) {
			if ( 0 === $sec7_use_parallax ) {
				$ka_css .= '.home-7-wide { background: url( ' . $sec7_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 8', $home_area, true ) ) {
		...
		$sec8_use_parallax = intval( get_theme_mod( 'canuck_section8_use_parallax', 0 ) );
		...
		if ( '' !== $sec8_bg_image ) {
			if ( 0 === $sec8_use_parallax ) {
				$ka_css .= '.home-8-wide { background: url( ' . $sec8_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 9', $home_area, true ) ) {
		...
		$sec9_use_parallax = intval( get_theme_mod( 'canuck_section9_use_parallax', 0 ) );
		$sec9_text = esc_html( get_theme_mod( 'canuck_section9_text_color', '#4c4c4c' ) );
		if ( '' !== $sec9_bg_image ) {
			if ( 0 === $sec9_use_parallax ) {
				$ka_css .= '.home-9-wide { background: url( ' . $sec9_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 10', $home_area, true ) ) {
		...
		$sec10_use_parallax = intval( get_theme_mod( 'canuck_section10_use_parallax', 0 ) );
		...
		if ( '' !== $sec10_bg_image ) {
			if ( 0 === $sec10_use_parallax ) {
				$ka_css .= '.home-10-wide { background: url( ' . $sec10_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 11', $home_area, true ) ) {
		...
		$sec11_use_parallax = intval( get_theme_mod( 'canuck_section11_use_parallax', 0 ) );
		...
		if ( '' !== $sec11_bg_image ) {
			if ( 0 === $sec11_use_parallax ) {
				$ka_css .= '.home-11-wide { background: url( ' . $sec11_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 12', $home_area, true ) ) {
		...
		$sec12_use_parallax = intval( get_theme_mod( 'canuck_section12_use_parallax', 0 ) );
		$sec12_text = esc_html( get_theme_mod( 'canuck_section12_text_color', '#4c4c4c' ) );
		if ( '' !== $sec12_bg_image ) {
			if ( 0 === $sec12_use_parallax ) {
				$ka_css .= '.home-12-wide { background: url( ' . $sec12_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	if ( in_array( 'Section 13', $home_area, true ) ) {
		...
		$sec13_use_parallax = intval( get_theme_mod( 'canuck_section13_use_parallax', 0 ) );
		$sec13_text = esc_html( get_theme_mod( 'canuck_section13_text_color', '#4c4c4c' ) );
		if ( '' !== $sec13_bg_image ) {
			if ( 0 === $sec13_use_parallax ) {
				$ka_css .= '.home-13-wide { background: url( ' . $sec13_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
			}
	...
	// Footer custom css.
	$show_footer = get_theme_mod( 'canuck_show_footer', 1 );
	...
	if ( 0 !== $show_footer && '' !== $footer_bg_image ) {
		$ka_css .= '#canuck-footer { background: url( ' . $footer_bg_image . ' );background-size: cover;background-repeat: no-repeat; }' . PHP_EOL;
